...
def evaluateInput(encoder, decoder, searcher, voc,input_sentence:str) -> str:
    try:
        # Get input sentence
        # Check if it is quit case
        if input_sentence == 'q' or input_sentence == 'quit': return 'No, I don\'t want to leave'
        # Normalize sentence
...
def talk(x:str) -> str:
    return evaluateInput(encoder, decoder, searcher, voc,x)
